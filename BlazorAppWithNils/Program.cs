...
namespace BlazorAppWithNils
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<ImplementedHashingHandler>();
            //builder.Services.AddSingleton<SymetriskEncrypttionHandler>();
            //builder.Services.AddSingleton<AsymetriskEncryptionHandler>();
            builder.Services.AddSingleton<ImplementedAsymetriskEncryptionHandler>();
